...
|
|-----------------------------------------------------------------------------
| $Author: vismln $    $Date: 2020-09-02 18:00:42 +0200 (Wed, 02 Sep 2020) $   $Revision: 140316 $
| $Id: vxlpubbase.h 140316 2020-09-02 16:00:42Z vismln $
|-----------------------------------------------------------------------------
...
#define XL_TRANSCEIVER_TYPE_PB_CAN_1462BT        0x0149
...
#define XL_ETH_EVENT_TAG_FRAMERX_SIMULATION             ((unsigned short)0x0550)  // Event data type T_XL_ETH_DATAFRAME_RX_SIMULATION  (with payload)
#define XL_ETH_EVENT_TAG_FRAMERX_ERROR_SIMULATION       ((unsigned short)0x0551)  // Event data type T_XL_ETH_DATAFRAME_RX_ERROR_SIMULATION (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ACK_SIMULATION         ((unsigned short)0x0552)  // Event data type T_XL_ETH_DATAFRAME_TX_SIMULATION (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_SIMULATION       ((unsigned short)0x0553)  // Event data type T_XL_ETH_DATAFRAME_TX_ERROR_SIMULATION (with payload)

#define XL_ETH_EVENT_TAG_FRAMERX_MEASUREMENT             ((unsigned short)0x0560)  // Event data type T_XL_ETH_DATAFRAME_RX_MEASUREMENT  (with payload)
#define XL_ETH_EVENT_TAG_FRAMERX_ERROR_MEASUREMENT       ((unsigned short)0x0561)  // Event data type T_XL_ETH_DATAFRAME_RX_ERROR_MEASUREMENT (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_MEASUREMENT             ((unsigned short)0x0562)  // Event data type T_XL_ETH_DATAFRAME_TX_MEASUREMENT (with payload)
#define XL_ETH_EVENT_TAG_FRAMETX_ERROR_MEASUREMENT       ((unsigned short)0x0563)  // Event data type T_XL_ETH_DATAFRAME_TX_ERROR_MEASUREMENT (with payload)
...
#define XL_ACTIVATE_RESET_CLOCK               8 // using this flag with time synchronisation protocols supported by Vector Timesync Service is not recommended
...
#define XL_ETH_RAW_FRAME_SIZE_MIN      (unsigned int)   24 // minimum buffer size for storing a "raw" Ethernet frame (including VLAN tags, if present)
...
#define XL_ETH_CHANNEL_CAP_IEEE100TX   0x0002         //Channel supports IEEE 802.3u (100-BASE-TX) and 802.3i (10BASE-T) - Ethernet and Fast Ethernet
...
#define XL_ETH_NETWORK_TX_ERROR_INVALID_LENGTH     ((unsigned int) 0x00000010) /* Invalid length error. Set when the frame has an invalid length as defined by IEEE802.3 */
#define XL_ETH_NETWORK_TX_ERROR_INVALID_CRC        ((unsigned int) 0x00000020) /* CRC error. Set when frame is transmitted with CRC-32 error but valid length */
...
#define XL_ETH_NETWORK_RX_ERROR_INVALID_LENGTH     ((unsigned int) 0x00000001) /* Invalid length error. Set when the receive frame has an invalid length as defined by IEEE802.3 */
#define XL_ETH_NETWORK_RX_ERROR_INVALID_CRC        ((unsigned int) 0x00000002) /* CRC error. Set when frame is received with CRC-32 error but valid length */
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_CHANNEL_CONFIG_V1)(
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_DEVICE_CONFIG_V1)(
  XLdrvConfigHandle            configHandle,
  XLdeviceDrvConfigListV1     *deviceCfgList);
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_VIRTUAL_PORT_CONFIG_V1)(
  XLdrvConfigHandle                configHandle,
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_MEASUREMENT_POINT_CONFIG_V1)(
  XLdrvConfigHandle                     configHandle,
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_SWITCH_CONFIG_V1)(
  XLdrvConfigHandle           configHandle,
  XLswitchDrvConfigListV1     *switchCfgList);
...
// network config interface
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_NETWORK_CONFIG_V1)(
  XLdrvConfigHandle           configHandle,
...
typedef XLstatus(_XL_EXPORT_API * TP_FCT_XLAPI_GET_DLL_CONFIG_V1)(
  XLdrvConfigHandle           configHandle,
  XLdllDrvConfigV1            *dllCfg);
...
*                 
*/
DECL_STDXL_FUNC(xlCreateDriverConfig, XLCREATEDRIVERCONFIG, (
...
*
*/
DECL_STDXL_FUNC(xlDestroyDriverConfig, XLDESTROYDRIVERCONFIG, (
  XLdrvConfigHandle  configHandle
  ));
...
*/
DECL_STDXL_FUNC ( xlSetGlobalTimeSync, XLSETGLOBALTIMESYNC, (XLulong newValue, 
                                                             XLulong *previousValue));
 ...
 *  \return XLstatus                       general status information
 */
DECL_STDXL_FUNC( xlMostGenerateLightError, XLFP_MOSTGENERATELIGHTERROR,(DEFPARAMS, XLulong lightOffTime, XLulong lightOnTime, unsigned short repeat));
 ...
 *  \return XLstatus                       general status information
 */
DECL_STDXL_FUNC( xlMostGenerateLockError,  XLFP_MOSTGENERATELOCKERROR, (DEFPARAMS, XLulong unmodTime, XLulong modTime, unsigned short repeat));
...
DECL_STDXL_FUNC(xlNetEthOpenNetwork, XLFP_NETETHOPENNETWORK, (
  ...
  XLnetworkHandle *pNetworkHandle,
  const char      *pAppName,
 ...
 *  \return XLstatus     general status information
 */
DECL_STDXL_FUNC(xlNetCloseNetwork, XLFP_NETCLOSENETWORK, (
 ...
 *  \return XLstatus     general status information
 */
DECL_STDXL_FUNC(xlNetActivateNetwork, XLFP_NETACTIVATENETWORK, (
  XLnetworkHandle networkHandle
  ));
 ...
 *  \return XLstatus     general status information
 */
DECL_STDXL_FUNC(xlNetDeactivateNetwork, XLFP_NETDEACTIVATENETWORK, (
  XLnetworkHandle networkHandle
  ));
...
DECL_STDXL_FUNC(xlNetEthReceive, XLFP_NETETHRECEIVE, (
  XLnetworkHandle     networkHandle,
  T_XL_NET_ETH_EVENT  *pEventBuffer,
 ...
 *  \return XLstatus     general status information
 */
DECL_STDXL_FUNC(xlNetSetNotification, XLFP_NETSETNOTIFICATION, (
  XLnetworkHandle networkHandle,
  XLhandle       *pHandle,
  int             queueLevel
  ));
...
*/
DECL_STDXL_FUNC(xlNetRequestMACAddress , XLFP_NETREQUESTMACADDRESS, (
  XLnetworkHandle             networkHandle,
...
*  \return XLstatus           general status information
*/
DECL_STDXL_FUNC(xlNetFlushReceiveQueue, XLFP_NETFLUSHRECEIVEQUEUE, (
  XLnetworkHandle             networkHandle
  ));
////////////////////////////////////////////////////////////////////////////////
